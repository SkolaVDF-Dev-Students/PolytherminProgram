...
sensor1 = Thermistor(pin_id=15, r_ref=984.0, offset=7, gain=1.0, v_ref=3.32)
sensor2 = Thermistor(pin_id=16, r_ref=984.0, offset=6, gain=1.0, v_ref=3.32)
sensor3 = Thermistor(pin_id=17, r_ref=984.0, offset=4, gain=1.0, v_ref=3.32)
